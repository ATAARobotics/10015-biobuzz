...
public class Shooter extends SubsystemBase {
    ...
    double hoodSlope;
    public static double RPM_LOW = 2700;  //2550;//2450;
    ...
    public static double HOOD_MAX_DEGREES = 38;//55.0;
    ...
    public double rpmMax(){
        rpmSlope = (RPM_HIGH - RPM_LOW) / (RPM_HIGH_DIST - RPM_LOW_DIST);
        rpmIntercept = RPM_LOW + (rpmSlope * -RPM_LOW_DIST);
    ...
    public double hoodAngleLinear(double rpm) {
       ...
       double hood = HOOD_MIN_DEGREES + (percent * range);
       return hood;
    }
    ...
    public void periodic() {
        ...
        if (MANUAL_HOOD > 0.0) {
            targetHood = degreeToServo(MANUAL_HOOD);
        }
